...
export const ExecutiveMasterSystemSuite: React.FC<ExecutiveMasterSystemSuiteProps> = ({
  ...
  const [updateResult, setUpdateResult] = useState<{
    ...
    status: "SYNCED",
    projectName: "mdanmedo-erp-sap-s-4hana-6103-ai-studio-f38p",
    version: "v4.5.2026",
    build: "BUILD-SAP-6103-REL-2026",
    date: "20/09/2026",
    officialUrl: "https://mdanmedo-erp-sap-s-4hana-6103-ai-st-iota.vercel.app",
          ...
          <div className="p-6 rounded-3xl bg-slate-900/95 border border-slate-800 space-y-5 shadow-xl">
              ...
              <div className="flex items-center gap-2">
                <button
                  onClick={() => {
                    ...
                    alert("تم نسخ الرابط الرسمي المعتمد (iota.vercel.app)!");
                  }}
              ...
              <div className="p-4 rounded-2xl bg-slate-950 border border-slate-800 flex flex-col justify-between gap-3">
                <div className="space-y-1">
                  ...
                  <div className="font-mono text-[#d4af37] font-bold text-xs sm:text-sm">
                    mdanmedo-erp-sap-s-4hana-6103-ai-studio-f38p
                  </div>
                  <div className="font-mono text-cyan-300 font-bold text-xs sm:text-sm break-all pt-1">
                    https://mdanmedo-erp-sap-s-4hana-6103-ai-st-iota.vercel.app
                  </div>
                </div>
                <a
                  href="https://mdanmedo-erp-sap-s-4hana-6103-ai-st-iota.vercel.app"
                  target="_blank"
            ...
            <div className="p-4 rounded-2xl bg-amber-950/20 border border-amber-500/30 space-y-2.5">
              ...
              <p className="text-[11px] text-slate-300 leading-relaxed">
                لإلغاء أي التباس؛ تم اعتماد مشروع <span className="text-[#d4af37] font-bold font-mono">mdanmedo-erp-sap-s-4hana-6103-ai-studio-f38p</span> حصرياً كمصدر رئيسي. المشاريع الـ 5 الأخرى (remix-...-qwf1, ...-zyxf, ...-studio, medo-erp-app, remix-...-ai-studio) تم استبعادها من منظومة الروابط وتوجيه كافة النداءات للرابط الموحد.
              </p>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 text-xs">
                <div className="p-3.5 rounded-xl bg-slate-950/70 border border-slate-800 space-y-1.5">
                  ...
                  <p className="text-[11px] text-slate-400">
                    مشروع <span className="font-mono text-cyan-300">...-f38p</span> نشط بالنشر التلقائي.
                  </p>
                </div>
            ...
            <div className="p-4 rounded-2xl bg-slate-950/90 border border-slate-800 space-y-3">
              ...
              <div className="space-y-2 font-mono text-[11px] text-slate-300">
                <div className="p-2 bg-slate-900 rounded-lg border border-slate-800 break-all">
                  ...
                  https://mdanmedo-erp-sap-s-4hana-6103-ai-st-iota.vercel.app/?tenant=[tenant-id]
                </div>
                <div className="p-2 bg-slate-900 rounded-lg border border-slate-800 break-all">
                  <span className="text-blue-400 font-bold">MANAGER: </span>
                  https://mdanmedo-erp-sap-s-4hana-6103-ai-st-iota.vercel.app/?tenant=[id]&role=MANAGER&token=AUTH_MGR_[id]&path=/employee/manager
                </div>
                <div className="p-2 bg-slate-900 rounded-lg border border-slate-800 break-all">
                  <span className="text-emerald-400 font-bold">ACCOUNTANT: </span>
                  https://mdanmedo-erp-sap-s-4hana-6103-ai-st-iota.vercel.app/?tenant=[id]&role=ACCOUNTANT&token=AUTH_ACC_[id]&path=/employee/accountant
                </div>
                <div className="p-2 bg-slate-900 rounded-lg border border-slate-800 break-all">
                  <span className="text-cyan-400 font-bold">CASHIER: </span>
                  https://mdanmedo-erp-sap-s-4hana-6103-ai-st-iota.vercel.app/?tenant=[id]&role=CASHIER&token=AUTH_SALES_[id]&path=/employee/sales
                </div>
                <div className="p-2 bg-slate-900 rounded-lg border border-slate-800 break-all">
                  <span className="text-purple-400 font-bold">PURCHASER: </span>
                  https://mdanmedo-erp-sap-s-4hana-6103-ai-st-iota.vercel.app/?tenant=[id]&role=PURCHASER&token=AUTH_PUR_[id]&path=/employee/purchase
                </div>
                <div className="p-2 bg-slate-900 rounded-lg border border-slate-800 break-all">
                  <span className="text-rose-400 font-bold">AUDITOR: </span>
                  https://mdanmedo-erp-sap-s-4hana-6103-ai-st-iota.vercel.app/?tenant=[id]&role=AUDITOR&token=AUTH_AUD_[id]&path=/employee/auditor
                </div>
              </div>
            </div>
          </div>
