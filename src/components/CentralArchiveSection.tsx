...
رابط التشغيل المعتمد: https://mdanmedo-erp-sap-s-4hana-6103-ai-st-iota.vercel.app
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-[11px]">
                  ...
                  <div className="p-3 rounded-xl bg-[#071829] border border-slate-800">
                    ...
                    <div className="font-mono text-blue-400 font-bold break-all flex items-center justify-between gap-1">
                      <span>https://mdanmedo-erp-sap-s-4hana-6103-ai-st-iota.vercel.app</span>
                      <button
                        onClick={() => handleCopy("https://mdanmedo-erp-sap-s-4hana-6103-ai-st-iota.vercel.app", "live_url")}
