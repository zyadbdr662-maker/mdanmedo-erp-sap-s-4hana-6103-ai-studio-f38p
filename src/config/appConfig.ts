 ...
 * 
 * Official Single Master Project: mdanmedo-erp-sap-s-4hana-6103-ai-studio-f38p
 * Official Live Vercel Domain: https://mdanmedo-erp-sap-s-4hana-6103-ai-st-iota.vercel.app
 * Official Custom Domain: https://medo-erp.us.ci
 */

export const VERCEL_PROJECT_NAME = "mdanmedo-erp-sap-s-4hana-6103-ai-studio-f38p";
export const OFFICIAL_APP_DOMAIN = "https://mdanmedo-erp-sap-s-4hana-6103-ai-st-iota.vercel.app";
